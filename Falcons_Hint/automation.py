...
def menuStart(phone,userID): 
    ...
    print("1. Press 1 to make directory in hdfs")
    print("2. Press 2 to store to hdfs")
    print("2. Press 3 to read from hdfs")
    print("3. Press 4 to delete from hdfs")
    print("4. Press 5 to run Spark Cluster")
    option = int(input())
    if option == 1:
